    ...
    sort(field, ascending, add = false, silent = false) {
        ...
        if (field) {
            if (Array.isArray(field)) {
                ...
                curSort = me.sorters.find(s => s.field === sorter.field);
                ...
                if (ascending === undefined || ascending === null) {
                    const sameField = curSort && ((typeof field === 'string' && curSort.field === field) || (typeof field === 'object' && curSort.field === field.field));
