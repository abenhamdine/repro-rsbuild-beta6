...
export default Target => class AjaxTransport extends (Target || Base) {
     ...
     * @property {String} [transport.load.paramName] Name of parameter in which a packet will be transferred. If not specified then a packet will be transferred in a request body (default).
     * @property {Object} [transport.load.params] Extra load request params if needed.
     * @property {Object} [transport.load.requestConfig] Additional request configuration:
     ...
     * @property {String} [transport.sync.paramName] Name of parameter in which a packet will be transferred. If not specified then a packet will be transferred in a request body (default).
     * @property {Object} [transport.sync.params] Extra sync request params if needed.
     * @property {Object} [transport.sync.requestConfig] Additional request configuration:
